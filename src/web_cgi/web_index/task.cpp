...
void getPostData(){
    ...
    try{
        ...
        switch(display){
            /*分支操作，添加此处*/
            /*==========================================*/
            case 1: cmd_setDevNet(value);   break;
            case 2: getGateway();           break;
            case 3: sysReboot();            break;
            case 5: getHexVersion();        break;
            case 6: getDNS();               break;
            case 7: setDNS(value);          break;
            case 8: cmd_setPostPswd(value); break;
            /*==========================================*/
