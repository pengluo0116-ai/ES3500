...
ES3500 是恩易科技（ENYI）的电梯安全报警主机系统，运行在 **Nano Pi M1 Plus** 上。
...
```bash
sudo dd if=ES3500_firmware_YYYYMMDD.img of=/dev/sdX bs=4M status=progress
```
...
```json
{
  ...
  "Parameters": { "Id": "6001", "Time": "2024-...", "Version": "ES1500_V2.0" },
